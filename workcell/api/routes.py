""" Originated from gradio: https://github.com/gradio-app/gradio/blob/main/gradio/routes.py
Implements a FastAPI server to run the workcell interface. Note that some types in this
...
from workcell.documentation import document, set_documentation_group
