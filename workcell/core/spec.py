"""
Convert pydantic models to typescript definitions.
Forked from https://github.com/phillipdupuis/pydantic-to-typescript/blob/master/pydantic2ts/cli/script.py
"""
import argparse
import importlib
import inspect
